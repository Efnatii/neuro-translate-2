 ...
 * @property {string} [category] Classified category used by the translation agent.
 *
 ...
 * @property {string} status idle|preparing|awaiting_categories|running|completing|done|failed|cancelled.
 ...
 * @property {string[]} [availableCategories] Categories available on the scanned page.
 ...
 * @property {string[]} [availableCategories] Available categories discovered during planning.
